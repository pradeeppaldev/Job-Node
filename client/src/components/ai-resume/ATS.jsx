...
const ATS = ({ score = 0, suggestions = [] }) => {
  ...
  return (
    <div className={`bg-gradient-to-b ${gradientClass} to-white rounded-2xl shadow-md w-full p-6 border border-gray-100`}>
      ...
      <div className="mb-6">
        <h3 className="text-xl font-semibold mb-2 text-gray-800">{subtitle}</h3>
